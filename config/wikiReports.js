/**
 * @file config/wikiReports.js
 * @description Single source of truth for wiki report metadata.
 *   Drives the index page, slug allowlist, and prev/next navigation.
 *   Adding a new report requires editing only this file.
 */
...
// Slug allowlist for security (WIKI-009)
const validSlugs = new Set(reports.map(r => r.slug));
