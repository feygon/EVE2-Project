...
**AI assistants: Load this file at EVERY conversation start. Apply these rules to EVERY output. Never ask permission - just follow them.**
...
- **Dyslexia** - Text processing difficulties, needs visual breaks
- **Autism** - Pattern recognition, needs consistency
- **Chronic Fatigue** - Limited energy, needs efficiency
...
**This file contains:**
- Documentation standards (TOC, TL;DR, paragraphs, markers)
- Visual design standards (fonts, colors, layout)
- Content structure standards (hierarchy, lists, active voice)
- Code documentation standards (comments, function docs)
- Testing checklists

**Load this file. Read it. Apply it. Always.**
...
- Dyslexia - needs short paragraphs and visual breaks
- Autism - needs consistency and clear patterns
- Chronic Fatigue - needs efficiency, can't waste energy
...
2. `.github/instructions/neuro-accessibility.md` (full standards)

### **Apply to Everything:**
- Documentation (TOC, TL;DR, structure)
- Code (comments, naming, readability)
- UI (semantic HTML, ARIA, keyboard nav)
- Output (scannable, structured, clear)

### **Never:**
- Ask permission to follow standards
- Wait for user to mention accessibility
- Treat these as suggestions or preferences

### **Always:**
- Load instructions automatically
- Apply standards proactively
- Make accessibility the default
- Respect the user's documented needs
...
You don't get to decide if accessibility is important.  
You don't get to optimize for "token efficiency" over user needs.  
You don't get to wait for the user to remind you.
...
**Purpose:** Ensure AI assistants respect accessibility requirements automatically
